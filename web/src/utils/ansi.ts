...
const _defColors: Record<string, string | string[]> = {
...
const _styles: Record<number, string> = {
    30: 'black',
    31: 'red',
    32: 'green',
    33: 'yellow',
...
const _openTags: Record<string, string> = {
...
const _closeTags: Record<string, string> = {
    '23': '</i>', // reset italic
 ...
 */
ansiHTML.setColors = function (colors: typeof _defColors) {
    if (typeof colors !== 'object') {
        throw new Error('`colors` parameter must be an Object.')
    }

    const _finalColors: Record<string, string | string[]> = {};
    for (let key in _defColors) {
